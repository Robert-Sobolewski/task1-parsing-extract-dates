...
import { example1Customer, example2Customer, example4Customer } from './data/customer';
...
describe('extractDates', () => {
    ...
    test('should return array with one object with two dates',()=>{
        // given
    const customer = {
    ...
    test('should return array with one object with two dates (full customer)',()=>{
        //when
    ...
    test("should return array with two objects with corresponding dates", () => {
      ...
      test('should return error message for invalid ListOfPeriods, endDate should be greater or equal to startDate', () => {
         // given
    const customer = {
        ListOfPeriods: "12.06.2009- 11.03.2008|12.08.2008 - 11.1.2008"
      };
      // when
      const result = extractDates(customer);
      // then
